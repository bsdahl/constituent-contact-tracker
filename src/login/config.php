...
$from_name = 'Contact Tracker'; //"From name" displayed on email
...
//$verifymsg = 'Click this link to verify your new account! ' . $_POST['email']; //Verify email message
$active_email = 'Your new account is now active! Click this link to log in!';//Active email message
//LOGIN FORM RESPONSE MESSAGES/ERRORS
$signupthanks = 'Thank you for signing up! The site administrator will verify your account and contact you shortly.';
